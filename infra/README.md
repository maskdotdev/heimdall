...
spikes, embedding backlog, review failures, publishing failures, LLM provider outages, cost
anomalies, indexing failures, and sandbox violations. The alert annotations link back to
