...
- Latest evaluation milestone: Phase #26 baseline comparison now includes case-level comparison
  ...
  failing a threshold gate. Evaluation artifact writing now also emits CI-safe JUnit XML with eval
  case and gate-check testcases for CI systems that collect test reports.
