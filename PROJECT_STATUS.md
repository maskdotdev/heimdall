...
- Latest TypeScript indexer milestone: `@repo/indexer-ts` now resolves relative TS/JS imports and
  ...
  when the target file exposes a same-named symbol. It also emits route records for clear TS/JS
  ...
  capabilities. It skips generated and vendored source files before parsing, symbol extraction, or
  chunking by applying common path, directory, minified bundle, protobuf/GraphQL, Python
  generated-file, and generated-header heuristics. It skips symlinked source entries before
