...
- Latest compliance evidence milestone: `@repo/security` now defines stable MVP compliance control
  ...
  digests. Collector tests verify that raw audit metadata and custom repository instructions are
