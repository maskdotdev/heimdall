...
- Latest indexer observability milestone: `@repo/indexer-driver` now records product-safe artifact
  ...
  dedicated nonzero CLI exit counters in addition to existing run, duration, timeout, output-byte,
  run span, CLI spawn span, and validation span telemetry.
