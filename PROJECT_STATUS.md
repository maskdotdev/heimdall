...
- Latest PR snapshot milestone: `@repo/pr-snapshot` now provides the first provider-neutral unified
  ...
  path sets, and rename pairs for retrieval handoff. Tests cover modified, renamed, quoted path,
  binary, hashing, commentability, unsafe-anchor, file-anchor, and change-set cases.
