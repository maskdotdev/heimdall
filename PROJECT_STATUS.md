...
- Latest compliance evidence milestone: `@repo/security` now defines stable MVP compliance control
  ...
  from exported evidence, and worker tests verify dispatch through the configured collector hook.
