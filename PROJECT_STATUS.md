...
| #11 TypeScript indexer | Partial | `packages/indexer-ts`, `packages/indexer-ts/test` | TypeScript indexer emits files, symbols, edges, chunks, manifest hashes, deterministic fixtures, and generated/vendor skip heuristics for path and header patterns. Broader language coverage and incremental behavior remain. |
...
- Latest TypeScript indexer milestone: `@repo/indexer-ts` now skips generated and vendored source
  ...
  bundle, protobuf/GraphQL, and generated-header heuristics.
