...
export const OBSERVABILITY_METRIC_NAMES = {
  ...
  llmEstimatedCostMicrosTotal: "code_review_agent.llm.estimated_cost_micros_total",
  ...
  llmTokensTotal: "code_review_agent.llm.tokens_total",
  ...
  queueDepth: "code_review_agent.queue.depth",
  ...
  queueOldestJobAgeMs: "code_review_agent.queue.oldest_job_age_ms",
...
export const OBSERVABILITY_SPAN_NAMES = {
  ...
  githubCreateCheckRun: "code_review_agent.github.create_check_run",
  githubCreateInstallationToken: "code_review_agent.github.create_installation_token",
  githubFetchDiff: "code_review_agent.github.fetch_diff",
  githubFetchPrSnapshot: "code_review_agent.github.fetch_pr_snapshot",
  githubPublishReview: "code_review_agent.github.publish_review",
  githubRestRequest: "code_review_agent.github.rest_request",
  indexerDriverRun: "code_review_agent.indexer_driver.run",
  indexerDriverSpawnCli: "code_review_agent.indexer_driver.spawn_cli",
  indexerDriverValidateResult: "code_review_agent.indexer_driver.validate_result",
  ...
  rulesCompilePolicy: "code_review_agent.rules.compile_policy",
  rulesEvaluateFinding: "code_review_agent.rules.evaluate_finding",
  rulesEvaluatePath: "code_review_agent.rules.evaluate_path",
  rulesEvaluateTrigger: "code_review_agent.rules.evaluate_trigger",
  ...
  sandboxCleanup: "code_review_agent.sandbox.cleanup",
  sandboxCollectArtifacts: "code_review_agent.sandbox.collect_artifacts",
  sandboxExecute: "code_review_agent.sandbox.execute",
  sandboxPrepare: "code_review_agent.sandbox.prepare",
